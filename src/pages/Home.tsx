          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="hover:shadow-lg transition-all hover:-translate-y-1 animate-fade-in" style={{ animationDelay: '0.1s' }}>
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Divisão das lojas com designers de interiores, arquitetos, montadores, instaladores, pedreiros, eletricistas, bombeiros hidráulicos e pintores
                </p>
            ...
            <Card className="hover:shadow-lg transition-all hover:-translate-y-1 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Split de recebíveis para peças e serviços. Elimine bitributação e economize até 60%.
                </p>
                <Button variant="link" className="p-0" asChild>
